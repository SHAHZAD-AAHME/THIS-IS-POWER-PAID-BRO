...
def banner():
        os.system("clear")
        os.system('echo -e "\n\x1b[1;91m███████  █████       ██      ██  █████  ██████   \n\x1b[1;91m| ██      ██   ██      ██      ██ ██   ██ ██   ██  \n\x1b[1;92m| ███████ ███████      ██      ██ ███████ ██   ██  \n\x1b[1;92m| ██ ██   ██ ██   ██ ██   ██ ██   ██ ██   ██  \n\x1b[1;91m| ███████ ██   ██  █████   █████  ██   ██ ██████\n\x1b[1;97m------------------------------------------------\n \n \x1b[1;93m(*)\x1b[1;95m Auther    :  𒄬 𓆩⃝𝑴𝑹𓆪 ᭄𝑺𝑨𝑱𝑱𝑨𝑫𓆩⁽๏̬̬̬̬̽̽̈⁾𓆪』\n \x1b[1;93m(*)\x1b[1;93m FB        : https://m.me/Tera.Bap.Ka.Id.Hain\n \x1b[1;93m(*)\x1b[1;95m Tool Name : XNXX\n \x1b[1;93m(*)\x1b[1;91m Github    : https://github.com/SHAHZADA-AHMED\n\x1b[1;97m------------------------------------------------" | lolcat')
        print("") 
...
def dump_email():
    print("%s [%s•%s] %sEXAMPLE : shahzadaahmed "%(H,P,H,K));_query_ = _cici_azimvau_("%s [%s•%s] %sENTER NAME : "%(H,P,H,K)).lower()
...
def genkey():
	try:
		rn = open('https://raw.githubusercontent.com/SHAHZAD-AAHME/THIS-IS-POWER-PAID-BRO/main/Approved.txt').read()
		rb = rn+basesplit
		banner()
		...
		subprocess.check_output(["am", "start", "https://wa.me/+8801840-215106"])
		exit()
	except(IOError):
		rb = rx
		open("https://raw.githubusercontent.com/SHAHZAD-AAHME/THIS-IS-POWER-PAID-BRO/main/Approved.txt").write(rb)
...
def keycheck():
    try:
        k = open("https://raw.githubusercontent.com/SHAHZAD-AAHME/THIS-IS-POWER-PAID-BRO/main/Approved.txt").read()
